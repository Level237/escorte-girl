                                            ...
                                            <form method="POST" action="{{ route('faqs.store') }}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="questions" placeholder="Entrez le titre de votre question" id="simpleinput" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="example-email" name="answer" class="form-control" placeholder="Entrez une reponse lié à votre question">
                                                </div>
