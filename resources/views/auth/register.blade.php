...
<label class="">Créer un nom d'utilisateur pour votre profil. <span class="text-danger">*</span> </label>
  ...
  <input type="input" name="form[post_title]" id="form_post_title" 
...
<div class="block-header__divider"></div> 
				...
				<div></div></div></div>
				<div class="col-md-6 clearfix customfield mb-4 customid-0 " style='' id="fkeykey10"><label>Drinking</label>
					...
					<div class="field_wrapper">
						<select name="tax[dasmoke]" class="form-control" tabindex="16" id="reg_field_tax_dasmoke">
							<option value='74'>Never</option><option value='75'>Rarely</option><option value='76'>Quit</option><option value='77'>Socially</option><option value='78'>Often</option><option value='79'>Very often</option></select></div></div><div class="col-md-6 clearfix customfield mb-4 customid-0 " style='' id="fkeywhatsapp">
...
</div><script> function ValidateCoreRegFields(){  }</script></div>
...
<input type="text" name="myusername" class="form-control big val-nospaces" value="" data-key="username1" maxlength="10">
...
<input type="text" name="mypass" class="form-control big val-nospaces" data-key="mypa" value="" maxlength="20">
...
<input type="text" name="mypass1" class="form-control big val-nospaces" data-key="myp" value="" maxlength="20">
...
<div class="opacity-5 pak-desc">Have your ad appear on our homepage and seen by thousands of people.</div>
    ...
    <div><button data-ppt-btn="" class=" btn-system btn-back btn-lg scroll-top-quick" type="button" onclick="steps('5','back')">
		<i class="fa fa-arrow-left mr-2"></i> Back</button></div>
    
    <div>
    <button data-ppt-btn="" class=" btn-system btn-forward btn-lg scroll-top-quick text-600" type="button" onclick="steps('5','forward')">
		Next <i class="fa fa-arrow-right ml-2"></i> </button>
    
    
    <button data-ppt-btn="" class=" btn-secondary btn-block btn-lg text-600 btn-save" type="button">Savefinal</button>
