...
<a href="{{ route('db.escort.index')}}"  ppt-list-item class="hover-bg-light active page-link-dashboard">
...
<a href="{{ route('db.escort.advertise')}}"  ppt-list-item class="hover-bg-light  page-link-sellspace">
<div class="d-flex flex-row p-md-2 py-3">
...
<a href="{{ route('db.escort.settings')}}"  ppt-list-item class="hover-bg-light  page-link-details">
<div class="d-flex flex-row p-md-2 py-3">
