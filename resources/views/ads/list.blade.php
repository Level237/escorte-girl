							 ...
							 <div class="p-4 bg-white" ppt-border1="" style="min-height:220px;">
							  <div class="d-sm-flex flex-sm-column">
								<div class="fs-4 text-600 mb-2">
								  ...
								  <a href="https://es10.premiummod.com/listing/ethel/" class="text-dark _adtitle">{{ ucfirst($ad['user']['username']) }} 
							   ...
							   <nav ppt-nav="" class="seperator pl-0 text-muted mb-3"> 
								...
								<div style="min-height:60px;">
								  <span class="shortcode_excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempus eleifend risus ut congue. Pellentesque nec lacus elit. Pellentesque convallis</span>...
								</div>
								
										<div>        
								<a href="https://es10.premiummod.com/listing/ethel/" data-ppt-btn="" class="btn-primary">View Profile</a>
								</div>
