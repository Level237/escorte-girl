            ...
            <div>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="age" class="block mb-2 text-sm font-medium text-gray-900 text-white">Quel est votre sexualité</label>
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <div class="mb-6">
                            <label for="age" class="block mb-2 text-sm font-medium text-gray-900 text-white">Quel est le nom de votre quartier?</label>
                        <select id="countries" name="quarter_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="height" class="block mb-2 text-sm font-medium text-gray-900 text-white">Quel est votre taille?</label>
                        <select id="height" name="height_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="weight" class="block mb-2 text-sm font-medium text-gray-900 text-white">Selectionnez votre poids?</label>
                        <select id="weight" name="weight_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex flex-col md:flex-row mt-6">
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="shape" class="block mb-2 text-sm font-medium text-gray-900 text-white">Selectionnez votre corpulence?</label>
                        <select id="shape" name="shape_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        ...
                        <label for="website-admin" class="block mb-2 text-sm font-medium text-gray-900 text-white">Entrez votre numero Whatsapp</label>
                        <div class="flex">
                        ...
                        <input type="number"  name="whatsapp_number" id="whatsapp_number" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="690394365">
                        </div>
