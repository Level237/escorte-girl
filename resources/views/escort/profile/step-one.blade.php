            ...
            <div>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <div class="mb-6">
                            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 text-white">Votre Nom Sur le Site *</label>
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <div class="mb-6">
                            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 text-white">Votre Email</label>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="age" class="block mb-2 text-sm font-medium text-gray-900 text-white">Votre Âge *</label>
                      ...
                      <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="age" class="block mb-2 text-sm font-medium text-gray-900 text-white">Vous Êtes? *</label>
                ...
                <div class="flex flex-col md:flex-row mt-6">
                    ...
                    <div class="w-full flex-1 mx-2 svelte-1l8159u">
                        <label for="age" class="block mb-2 text-sm font-medium text-gray-900 text-white">Ville de résidence *</label>
